#!/bin/bash
# Controlled perturbation evaluation - Parallel - MULTILAYER features
...
#   PHASE1_PRESET=totalsegmentermri_core ./run_perturbation_parallel_multilayer.sh
#   PHASE1_PRESET=totalsegmenter_ct_core ./run_perturbation_parallel_multilayer.sh
